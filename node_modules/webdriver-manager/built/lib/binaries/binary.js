...
var Binary = (function () {
    ...
    Binary.prototype.prefix = function () { return this.prefixDefault; };
    Binary.prototype.version = function () { return this.versionCustom; };
    Binary.prototype.suffix = function (ostype, arch) { return this.suffixDefault; };
    Binary.prototype.filename = function (ostype, arch) { return this.prefix() + this.version() + this.suffix(ostype, arch); };
    /**
     * @param ostype The operating system.
    ...
    Binary.prototype.shortVersion = function (version) { return version.slice(0, version.lastIndexOf('.')); };
    /**
     * A base class method that should be overridden.
     */
    Binary.prototype.id = function () { return 'not implemented'; };
    /**
     * A base class method that should be overridden.
     */
    Binary.prototype.versionDefault = function () { return 'not implemented'; };
    /**
     * A base class method that should be overridden.
     */
    Binary.prototype.url = function (ostype, arch) { return 'not implemented'; };
    /**
     * Delete an instance of this binary from the file system
     */
    Binary.prototype.remove = function (filename) { fs.unlinkSync(filename); };
    return Binary;
}());
